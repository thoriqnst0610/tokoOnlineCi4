<section id="toko">
    <div class="container-fluid">
        <div class="row no-gutters" style="margin-top: 48px;">
            ...
            <!-- Modal -->
            <div class="modal fade" id="produkBeli" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <h5 id="halo"></h5>
                                <div class="col-md-6">
                                    <img class="img-fluid" id="gambarProdukBeli" alt="Gambar Produk">
                                </div>
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        <tr>
                                            <th>Nama Produk</th>
                                            <td id="namaProdukBeli"></td>
                                        </tr>
                                        <tr>
                                            <th>Type Produk</th>
                                            <td id="jenisProdukBeli"></td>
                                        </tr>
                                        <tr>
                                            <th>Rating Produk</th>
                                        ...
                                        <tr>
                                            <th>Tersedia</th>
                                            <td id="tersediaProdukBeli"></td>
                                        </tr>
                                        <tr>
                                            <th>Harga</th>
                                            <td id="hargaProdukBeli"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="" id="beliProdukBeli" type="button" class="btn btn-primary">Beli</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card mb-2 ">
                            ...
                            <div class="card-body bg-light">
                                ...
                                <i class="fas fa-star-half-alt text-success"></i>
                                <i class="far fa-star text-success"></i><br>
                                <button class="btn btn-primary" data-bs-target="#produkBeli"
                                    data-bs-toggle="modal" onclick="beliProduk('<?= htmlspecialchars($produk['idProduk'], ENT_QUOTES, 'UTF-8') ?>')">Detail</button>
